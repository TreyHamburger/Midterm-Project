...
public class PlayerController : MonoBehaviour
{
    ...
    private float horizontal, vertical, mouseX, mouseY, camXRotation, moveMultipler;
    ...
    void GetInput()
    {
        ...
        moveMultiplier = Input.GetButton("Sprint") ? sprintMultiplier : 1; // if statement, if (?) Input.Button is true, Sprintmulitplier is active.
    }
